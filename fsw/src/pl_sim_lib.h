...
#define PL_SIM_LIB_POWER_INIT_COMPLETE_EID  (EdsParam_APP_C_FW_LIB_BASE_EID + 0)
#define PL_SIM_LIB_POWER_INVALID_STATE_EID  (EdsParam_APP_C_FW_LIB_BASE_EID + 1)
#define PL_SIM_LIB_POWER_TRANSITION_EID     (EdsParam_APP_C_FW_LIB_BASE_EID + 2)
#define PL_SIM_LIB_DETECTOR_RESET_CMD_EID   (EdsParam_APP_C_FW_LIB_BASE_EID + 3)
#define PL_SIM_LIB_DETECTOR_RESET_EID       (EdsParam_APP_C_FW_LIB_BASE_EID + 4)
#define PL_SIM_LIB_DETECTOR_SIM_ERR_EID     (EdsParam_APP_C_FW_LIB_BASE_EID + 5)
